...
const FooterComponent = () => {
  return (
    <footer className="relative z-10  pt-20 pb-10 lg:pt-[120px] lg:pb-20 bg-slate-900 text-slate-50">
        ...
        <div className="-mx-4 flex flex-wrap">
            ...
            <div className="mb-10 w-full">
              <a href="/" className="mb-6 inline-block max-w-[160px]">
                <Image
                  ...
                  height="auto"
                  src={logo}
                  alt="Eastman logistics"
                  className="max-w-full"
                />
              </a>
              <p className="text-body-color mb-7 text-base">
                Barista Gurus: Elevating Coffee Expertise. Your journey to
                mastering the art and science of coffee, from cultivation to
                cup, guided by industry-leading professionals.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-6 w-full">
              <h4 className="text-dark mb-3 text-lg font-semibold">Courses</h4>
              <ul>
                <li>
                  <a
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-6 w-full">
              <h4 className="text-dark mb-3 text-lg font-semibold">Company</h4>
              <ul>
                <li>
                  <a
                    href="#about"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-6 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://cornsilk-louse.vercel.app/desk/"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                  >
                    Admin Login
                  </a>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-6 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a
                  href="https://www.facebook.com/profile.php?id=100075841555890&mibextid=ZbWKwL"
                ...
                <a
                  title="Linkedin"
                  href="https://www.linkedin.com/company/eastman-logistics-ltd/"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="14"
