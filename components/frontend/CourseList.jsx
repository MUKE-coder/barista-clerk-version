...
import BrowseCourseList from "../admin/BrowseCourseList";
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className=" md:max-w-[720px] mt-3 text-gray-500 mx-auto">
          Dive into a world of coffee excellence through our expert-led courses.
          Elevate your knowledge, refine your skills, and discover the true
          essence of coffee, from cultivation to cup.
        </p>
      </div>
      ...
      {/* <BrowseCourseList getCourses={courses} /> */}
    </section>
  );
}
